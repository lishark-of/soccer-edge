...
RISK_PROFILES = {
    "conservative": {
        ...
        "max_same_play_type_2x1": 1,
        "max_same_play_type_3x1": 2,
        "same_play_type_score_penalty": 0.14,
        "combo_homogeneity_penalty_unit": 0.08,
        "max_same_direction_2x1": 1,
        "max_same_direction_3x1": 2,
        "single_play_concentration_penalty": 0.08,
        "use_play_type_learning": True,
        "play_type_learning_min_attempts": 10,
        "play_type_learning_penalty_cap": 0.12,
        "play_type_learning_roi_floor": -0.02,
        "use_strategy_adjustments": True,
        "strategy_adjustment_penalty_cap": 0.12,
        "short_cycle_mode": True,
        "short_cycle_market_agreement_bonus": 0.05,
        "short_cycle_robust_value_bonus": 0.04,
    },
    "balanced": {
        ...
        "max_same_play_type_3x1": 2,
        "same_play_type_score_penalty": 0.14,
        "combo_homogeneity_penalty_unit": 0.07,
        "max_same_direction_2x1": 1,
        "max_same_direction_3x1": 2,
        "single_play_concentration_penalty": 0.07,
        "use_play_type_learning": True,
        "play_type_learning_min_attempts": 10,
        "play_type_learning_penalty_cap": 0.10,
        "play_type_learning_roi_floor": -0.02,
        "use_strategy_adjustments": True,
        "strategy_adjustment_penalty_cap": 0.10,
        "short_cycle_mode": True,
        "short_cycle_market_agreement_bonus": 0.06,
        "short_cycle_robust_value_bonus": 0.045,
    },
    "aggressive": {
        ...
        "max_same_play_type_3x1": 2,
        "same_play_type_score_penalty": 0.14,
        "combo_homogeneity_penalty_unit": 0.06,
        "max_same_direction_2x1": 1,
        "max_same_direction_3x1": 2,
        "single_play_concentration_penalty": 0.06,
        "use_play_type_learning": True,
        "play_type_learning_min_attempts": 10,
        "play_type_learning_penalty_cap": 0.08,
        "play_type_learning_roi_floor": -0.02,
        "use_strategy_adjustments": True,
        "strategy_adjustment_penalty_cap": 0.08,
        "short_cycle_mode": True,
        "short_cycle_market_agreement_bonus": 0.07,
        "short_cycle_robust_value_bonus": 0.05,
    },
}
