...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = optimize_portfolio(candidates, bankroll=args.bankroll, config={"enable_3x1": args.enable_3x1})
        ...
        if args.format == "json":
            ...
            print(f"赛前组合优化完成：推荐纸面投入 ¥{result.get('recommended_paper_exposure', 0):,.2f}")
